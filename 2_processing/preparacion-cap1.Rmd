...
elsoc_gs <- elsoc_2016 %>% 
  ...
  dplyr::select(idencuesta, estrato, comuna, comuna_cod, #ids
         ...
         m0_sexo, m0_edad, m01, d01_01, m33, m34_03, c12_01) #sociodemográficas
...
elsoc_gs <- elsoc_gs %>%
  ...
  mutate(apbr = factor(case_when(apbi < 2 ~ 1, apbi < 3 ~ 2,
         ...
         segu = factor(car::recode(t10, "1:2=1;3=2;4:5=3"),
                           labels = c("Experiencia de inseguridad",
         ...
         repb = factor(car::recode(t08, "1:2=1;3=2;4:5=3"),
                             labels = c("Estigmatizado",
                                        "Ni Estigmatizado Ni Prestigioso", 
                                        "Prestigioso")),
