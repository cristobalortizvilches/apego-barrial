...
export_summs(reg1,reg2,reg3,reg4,reg5, scale = TRUE ,coefs = c("Intercepto"="(Intercept)","Conflicto Micro"="conflicto_micro","Sentimiento Inseguridad"="sentimiento_inseguridad","Experiencias de Crimen"="exp_crimen","Reputacion Barrial"="rep_barrial","Economia Urbana"="econ_urb","Calidad de RR.SS."="calidad_rrss","Confianza en Vecinos"="confianza","Participacion Activa"="participacion3","Participacion Inactiva"="participacion2","Lazos sociales"="lazos","Satisfacción Barrial"="satisf_barrial"))
```
